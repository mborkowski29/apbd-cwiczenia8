...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            var departments = Dept.GetDepts();
            var employees = Emp.GetEmps();

            return departments.Where(dept => employees.Count(emp => emp.Deptno == dept.Deptno) == 5 ||
                                             !employees.Any(emp => emp.Deptno == dept.Deptno))
